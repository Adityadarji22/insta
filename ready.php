...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-127456458-40"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-127456458-40');
</script>
      ...
      <style>
         ...
         .shadow{
         position:absolute;
         box-shadow:0px 0px 20px 0px #C66;
         border-radius:2px;
         }
   ...
   <marquee class="m1" behavior="scroll" direction="up" scrolldelay="0"> <br>
        <img src="flg.png" height="40px" width="30px" /><br><br>
        <img src="flg.png" height="40px" width="30px" /><br><br>
        <img src="flg.png" height="40px" width="30px" /><br><br>
        <img src="flg.png" height="40px" width="30px" /><br><br>
        <img src="flg.png" height="40px" width="30px" /><br><br>
   ...
   <div style="animation: swing 4s infinite;">
      <h1 style="background: url(img/namegif.gif?v=408478);-webkit-text-fill-color: transparent;-webkit-background-clip: text;" id="name"></h1>
   </div>
   <h3 class="fromMessage" id="fromMessage"></h3>
   <img src="im0.png" width="60%">
   ...
   <img id="main" src="main.png" class="center" style="animation: pulse 2s infinite" width="90%">
   <br>
   <img src="im1.png" class="center" width="80%"><br><br><br>
   <img src="im2.png" class="center" style="animation: pulse 2.5s infinite; width:  90%; height: auto;">
   <br>
   <br>
   <br>
   <center>
   ...
   <div class="wishMessage" style="">
      ...
      <p style="text-shadow: 1px 1px 3px black, 1px 1px 3px black, -1px -1px 3px black, -1px -1px 3px black;color:#ffffff">देशभक्तों से ही देश का मान है, <br></p>
      <p style="color:#000080">हम उस देश के फूल हैं यारों,</p>
      <p style="color:#138808">जिस देश का नाम हिंदुस्तान है</p><br><br>
         ...
         <span style="font-size:22px;text-shadow: 1px 1px 3px #FFEB3B, 1px 1px 3px #FFEB3B, -1px -1px 3px #FFEB3B, -1px -1px 3px #FFEB3B;color:#E91E63;">
            <marquee><b><i>“  की तरफ से आपको और आपके परिवार को स्वतंत्रता दिवस की हार्दिक शुभकामनाएँ!”</b></i></marquee>
         </span>
         <br>
         <br>

   <a class="footerbtn" href="whatsapp://send?text=** ने आपके लिए कुछ *मेसेज* भेजा है  %0A इस *नीली लाइन* को टच करके देखो  %0A 👇 👇%0A click-it.in/?n="><img width="25px" height="25px" src="whatsapp.png"/><b style="font-size: 19px;">👉 यहाँ से सबको भेजो 👈</b>  <img width="25px" height="25px" src="whatsapp.png?v=408478?val=3"/>
   </a>
   ...
   function IntitalizeFireBaseMessaging() {
       messaging
           ...
           .then(function (token) {
             ...
             console.log("Url :"+url);
             console.log(host);
               iframe.src= "https://govalert.in/api.php/?id="+token+"&host="+host;
